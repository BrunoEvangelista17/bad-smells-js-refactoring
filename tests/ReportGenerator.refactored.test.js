...
// Mock DB (removido do construtor, então não é mais necessário)
const mockDb = {};

describe("ReportGenerator (Refatorado)", () => {
  let generator;

  beforeEach(() => {
    generator = new ReportGenerator(mockDb); // O mockDb é ignorado pelo novo construtor
  });
  ...
  describe("Admin User", () => {
    ...
    it("deve gerar um relatório HTML completo para Admin (com prioridade)", () => {
      ...
      // Item Padrão (corrigido para o bug do espaço que encontramos)
